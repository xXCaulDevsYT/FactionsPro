        ...
        if ($sender instanceof Player) {
            ...
            if (strtolower($command->getName()) === "f") {
                if (empty($args)) {
                    ...
                    if ($args[0] == "war") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Disabled: §7Coming Soon!"));
                            return true;
                        }
                    ...
                    if ($args[0] == "create") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f create <name>"));
                            return true;
                        }
                        if (!($this->alphanum($args[1]))) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You may only use letters or numbers"));
                            return true;
                        }
                        if ($this->plugin->isNameBanned($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c This name is not allowed"));
                            return true;
                        }
                        if ($this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The Faction already exists"));
                            return true;
                        }
                        if (strlen($args[1]) > $this->plugin->prefs->get("MaxFactionNameLength")) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c That name is too long, please try again"));
                            return true;
                        }
                        if ($this->plugin->isInFaction($sender->getName())) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must leave the faction first"));
                            return true;
                        } else {
                            $factionName = $args[1];
                            $rank = "Leader";
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Faction created", true));
                            return true;
                        }
                    }
                    ...
                    if ($args[0] == "invite") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f invite <player>"));
                            return true;
                        }
                        if ($this->plugin->isFactionFull($this->plugin->getPlayerFaction($playerName))) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Factions is full"));
                            return true;
                        }
                        $invited = $this->plugin->getServer()->getPlayerExact($args[1]);
                        if (!($invited instanceof Player)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Player not online"));
                            return true;
                        }
                        if ($this->plugin->isInFaction($invited->getName()) == true) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Player is currently in a faction"));
                            return true;
                        }
                        if ($this->plugin->prefs->get("OnlyLeadersAndOfficersCanInvite")) {
                            if (!($this->plugin->isOfficer($playerName) || $this->plugin->isLeader($playerName))) {
                                $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Only your faction leader/officers can invite"));
                                return true;
                            }
                        }
                        if ($invited->getName() == $playerName) {

                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can't invite yourself to your own faction"));
                            return true;
                        }
                        ...
                        $invited->sendMessage($this->plugin->formatMessage("§l§d»§r§d You have been invited to §7$factionName. §dType '§7/f accept' §dor '§7/f deny' §dinto chat to accept or deny!", true));
                    }
                    ...
                    if ($args[0] == "leader") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f leader <player>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($sender->getName())) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to use this"));
                            return true;
                        }
                        if (!$this->plugin->isLeader($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be leader to use this"));
                            return true;
                        }
                        if ($this->plugin->getPlayerFaction($playerName) != $this->plugin->getPlayerFaction($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Add player to faction first"));
                            return true;
                        }
                        ...
                        if ($args[1] == $sender->getName()) {
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can't transfer the leadership to yourself"));
                            return true;
                        }
                        $factionName = $this->plugin->getPlayerFaction($playerName);
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§e You are no longer leader", true));
                        $this->plugin->getServer()->getPlayerExact($args[1])->sendMessage($this->plugin->formatMessage("§l§a»§r§a You are now leader \nof §7$factionName!", true));
                        $this->plugin->updateTag($sender->getName());
                    ...
                    if ($args[0] == "promote") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f promote <player>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($sender->getName())) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to use this"));
                        ...
                        if ($this->plugin->getPlayerFaction($playerName) != $this->plugin->getPlayerFaction($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Player is not in this faction"));
                            return true;
                        }
                        if ($args[1] == $sender->getName()) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can't promote yourself"));
                            return true;
                        }

                        if ($this->plugin->isOfficer($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Player is already Officer"));
                            return true;
                        }
                        $factionName = $this->plugin->getPlayerFaction($playerName);
                        $stmt = $this->plugin->db->prepare("INSERT OR REPLACE INTO master (player, faction, rank) VALUES (:player, :faction, :rank);");
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§7 $args[1] §ahas been promoted to Officer", true));

                        if ($promotee instanceof Player) {
                            $promotee->sendMessage($this->plugin->formatMessage("§l§a»§r§a You were promoted to officer of §7$factionName!", true));
                            $this->plugin->updateTag($this->plugin->getServer()->getPlayerExact($args[1])->getName());
                            return true;
                        }
                    }
                    ...
                    if ($args[0] == "demote") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usgae: §7/f demote <player>"));
                            return true;
                        }
                        ...
                        if ($args[1] == $sender->getName()) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can't demote yourself"));
                            return true;
                        }
                        if (!$this->plugin->isOfficer($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Player is already Member"));
                            return true;
                        }
                        $factionName = $this->plugin->getPlayerFaction($playerName);
                        $stmt = $this->plugin->db->prepare("INSERT OR REPLACE INTO master (player, faction, rank) VALUES (:player, :faction, :rank);");
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§7 $args[1] §ahas been demoted to Member", true));
                        if ($demotee instanceof Player) {
                            $demotee->sendMessage($this->plugin->formatMessage("§l§a»§r§a You were demoted to member of §7$factionName!", true));
                            $this->plugin->updateTag($this->plugin->getServer()->getPlayerExact($args[1])->getName());
                            return true;
                        }
                    }
                    ...
                    if ($args[0] == "kick") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f kick <player>"));
                            return true;
                        }
                        if ($this->plugin->isInFaction($sender->getName()) == false) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to use this"));
                        ...
                        if ($args[1] == $sender->getName()) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can't kick yourself"));
                            return true;
                        }
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a You successfully kicked $args[1]", true));
                        ...
                        if ($kicked instanceof Player) {
                            $kicked->sendMessage($this->plugin->formatMessage("§l§a»§r§a You have been kicked from \n $factionName", true));
                            $this->plugin->updateTag($this->plugin->getServer()->getPlayerExact($args[1])->getName());
                            return true;
                        }
                    }
                    ...
                    if (strtolower($args[0]) == 'claim') {
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction."));
                            return true;
                        }
                        if (!$this->plugin->isLeader($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§cYou must be leader to use this."));
                            return true;
                        }
                        if (!in_array($sender->getPlayer()->getLevel()->getName(), $this->plugin->prefs->get("ClaimWorlds"))) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can only claim in Faction Worlds: " . implode(" ", $this->plugin->prefs->get("ClaimWorlds"))));
                            return true;
                        }

                        if ($this->plugin->inOwnPlot($sender)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction has already claimed this area."));
                            return true;
                        }
                        ...
                        if ($this->plugin->getNumberOfPlayers($faction) < $this->plugin->prefs->get("PlayersNeededInFactionToClaimAPlot")) {
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You need §7$needed_players §cmore players in your faction to claim a faction plot"));
                            return true;
                        }
                        if ($this->plugin->getFactionPower($faction) < $this->plugin->prefs->get("PowerNeededToClaimAPlot")) {
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction doesn't have enough DTR to claim a land."));
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c §7$needed_power §cDTR is required but your faction has only §7$faction_power DTR."));
                            return true;
                        }
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Getting your coordinates...", true));
                        $plot_size = $this->plugin->prefs->get("PlotSize");
                        $faction_power = $this->plugin->getFactionPower($faction);
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Your land has been claimed.", true));
                    }
                    if (strtolower($args[0]) == 'plotinfo') {
                        ...
                        if (!$this->plugin->isInPlot($sender)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§aThis plot is not claimed by anyone. You can claim it by typing /f claim", true));
                            return true;
                        }

                        $fac = $this->plugin->factionFromPoint($x, $z, $sender->getPlayer()->getLevel()->getName());
                        $power = $this->plugin->getFactionPower($fac);
                        $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c This plot is claimed by §7$fac §cwith §7$power DTR"));
                    }
                    ...
                    if (strtolower($args[0]) == 'forcedelete') {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("STAFF ONLY: /f forcedelete <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                        ...
                        if (!($sender->isOp())) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c No Permision!"));
                            return true;
                        }
                    ...
                    if (strtolower($args[0]) == 'addstrto') {
                        ...
                        if (!($sender->isOp())) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§cError§r§c No Permision!"));
                            return true;
                        }
                    ...
                    if (strtolower($args[0]) == 'pf') {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f pf <player>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The selected player is not in a faction or doesn't exist."));
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Make sure the name of the selected player is spelled EXACTLY."));
                            return true;
                        }
                    ...
                    if (strtolower($args[0]) == 'overclaim') {
                        ...
                        if ($this->plugin->getNumberOfPlayers($faction) < $this->plugin->prefs->get("PlayersNeededInFactionToClaimAPlot")) {
                            ...
                            $needed_players = $this->plugin->prefs->get("PlayersNeededInFactionToClaimAPlot") -
                                    $this->plugin->getNumberOfPlayers($faction);
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You need $needed_players more players in your faction to overclaim a faction plot"));
                            return true;
                        }
                        if ($this->plugin->getFactionPower($faction) < $this->plugin->prefs->get("PowerNeededToClaimAPlot")) {
                            $needed_power = $this->plugin->prefs->get("PowerNeededToClaimAPlot");
                            $faction_power = $this->plugin->getFactionPower($faction);
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction doesn't have enough DTR to claim a land."));
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c $needed_power DTR is required but your faction has only $faction_power DTR."));
                            return true;
                        }
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Getting your coordinates...", true));
                        $x = floor($sender->getX());
                        ...
                        if ($this->plugin->prefs->get("EnableOverClaim")) {
                            if ($this->plugin->isInPlot($sender)) {
                                ...
                                if ($this->plugin->inOwnPlot($sender)) {
                                    $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can't overclaim your own plot."));
                                    return true;
                                } else {
                                    if ($faction_ours_power < $faction_victim_power) {
                                        $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You can't overclaim the plot of $faction_victim because your DTR is lower than theirs."));
                                        return true;
                                    } else {
                                        ...
                                        $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The land of $faction_victim has been claimed. It is now yours.", true));
                                        return true;
                                    }
                                }
                            } else {
                                $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction plot."));
                                return true;
                            }
                        } else {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Overclaiming is disabled."));
                            return true;
                        }
                    }
                    ...
                    if (strtolower($args[0]) == "unclaim") {
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Your land has been unclaimed", true));
                    }
                    ...
                    if (strtolower($args[0]) == "desc") {
                        ...
                        $sender->sendMessage($this->plugin->formatMessage("§l§e»§r§e Type your message in chat. It will not be visible to other players", true));
                    ...
                    if (strtolower($args[0]) == "accept") {
                        ...
                        if (empty($array) == true) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You have not been invited to any factions"));
                            return true;
                        }
                        ...
                        if (($currentTime - $invitedTime) <= 60) { //This should be configurable
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a You successfully joined $faction", true));
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Invite has timed out"));
                    ...
                    if (strtolower($args[0]) == "deny") {
                        ...
                        if (($currentTime - $invitedTime) <= 60) { //This should be configurable
                            $this->plugin->db->query("DELETE FROM confirm WHERE player='$lowercaseName';");
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Invite declined", true));
                    ...
                    if (strtolower($args[0]) == "del") {
                        if ($this->plugin->isInFaction($playerName) == true) {
                            if ($this->plugin->isLeader($playerName)) {
                                ...
                                $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Faction successfully disbanded and the faction plot was unclaimed", true));
                                $this->plugin->updateTag($sender->getName());
								unset($this->plugin->factionChatActive[$playerName]);
								unset($this->plugin->allyChatActive[$playerName]);
							} else {
                                $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You are not leader!"));
                            }
                        } else {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You are not in a faction!"));
                        }
                    }
                    ...
                    if (strtolower($args[0] == "leave")) {
                        if ($this->plugin->isLeader($playerName) == false) {
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a You successfully left $faction", true));
                            $this->plugin->subtractFactionPower($faction, $this->plugin->prefs->get("PowerGainedPerPlayerInFaction"));
                            $this->plugin->updateTag($sender->getName());
							unset($this->plugin->factionChatActive[$playerName]);
							unset($this->plugin->allyChatActive[$playerName]);
                        } else {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must delete the faction or give\nleadership to someone else first"));
                        }
                    }
                    ...
                    if (strtolower($args[0] == "sethome")) {
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to do this"));
                            return true;
                        }
                        if (!$this->plugin->isLeader($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be leader to set home"));
                            return true;
                        }
                        ...
                        $result = $stmt->execute();
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Home set", true));
                    }
                    ...
                    if (strtolower($args[0] == "unsethome")) {
                        ...
                        if (!$this->plugin->isLeader($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be leader to unset home"));
                            return true;
                        }
                        $faction = $this->plugin->getPlayerFaction($sender->getName());
                        $this->plugin->db->query("DELETE FROM home WHERE faction = '$faction';");
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Home unset", true));
                    }
                    ...
                    if (strtolower($args[0] == "home")) {
                        ...
                        if (!empty($array)) {
                        	if ($array['world'] === null || $array['world'] === ""){
								$sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Home is missing world name, please delete and make it again"));
								return true;
							}
							if(Server::getInstance()->loadLevel($array['world']) === false){
								$sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The world '" . $array['world'] .  "'' could not be found"));
								return true;
							}
							$level = Server::getInstance()->getLevelByName($array['world']);
                            $sender->getPlayer()->teleport(new Position($array['x'], $array['y'], $array['z'], $level));
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Teleported home", true));
                        } else {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Home is not set"));
                        }
                    }
                    ...
                    if (strtolower($args[0] == "membersof")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f membersof <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The requested faction doesn't exist"));
                            return true;
                        }
                    ...
                    if (strtolower($args[0] == "officersof")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f officersof <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The requested faction doesn't exist"));
                    ...
                    if (strtolower($args[0] == "leaderof")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f leaderof <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The requested faction doesn't exist"));
                    ...
                    if (strtolower($args[0] == "say")) {
                        if (true) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c /f say is disabled"));
                            return true;
                        }
                        if (!($this->plugin->isInFaction($playerName))) {

                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to send faction messages"));
                            return true;
                        }
                        $r = count($args);
                        $row = array();
                    ...
                    if (strtolower($args[0] == "enemywith")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7 /f enemywith <faction>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to do this"));
                        ...
                        if (!$this->plugin->isLeader($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be the leader to do this"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The requested faction doesn't exist"));
                        ...
                        if ($this->plugin->getPlayerFaction($playerName) == $args[1]) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c A faction can not be an enemy of itself"));
                            return true;
                        }
                        if ($this->plugin->areAllies($this->plugin->getPlayerFaction($playerName), $args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Your faction is an ally of $args[1]"));
                            return true;
                        }
						if ($this->plugin->areEnemies($this->plugin->getPlayerFaction($playerName), $args[1])) {
							$sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction is already an enemy of $args[1]"));
							return true;
						}
                        $fac = $this->plugin->getPlayerFaction($playerName);
                        ...
                        if (!($leader instanceof Player)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The leader of the requested faction is offline"));
                        } else {
							$leader->sendMessage($this->plugin->formatMessage("§l§e»§r§e The leader of $fac has declared your factions are enemies", true));
						}
                        $this->plugin->setEnemies($fac, $args[1]);
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a You are now enemies with $args[1]!", true));
                    }
				if (strtolower($args[0] == "notenemy")) {
					if (!isset($args[1])) {
						$sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f notenemy <faction>"));
						return true;
					}
					if (!$this->plugin->isInFaction($playerName)) {
						$sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to do this"));
					...
					if(!($leader instanceof Player)) {
						...
						$leader->sendMessage($this->plugin->formatMessage("§l§e»§r§e The leader of $fac has declared your factions are no longer enemies", true));
					}
					$sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a You are no longer enemies with $args[1]!", true));
				}
                    if (strtolower($args[0] == "allywith")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f allywith <faction>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be in a faction to do this"));
                        ...
                        if ($this->plugin->getPlayerFaction($playerName) == $args[1]) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction can not ally with itself"));
                            return true;
                        }
                        if ($this->plugin->areAllies($this->plugin->getPlayerFaction($playerName), $args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction is already allied with $args[1]"));
                            return true;
                        }
                        $fac = $this->plugin->getPlayerFaction($playerName);
                        $leader = $this->plugin->getServer()->getPlayerExact($this->plugin->getLeader($args[1]));
                        ...
                        if ($this->plugin->getAlliesCount($args[1]) >= $this->plugin->getAlliesLimit()) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c The requested faction has the maximum amount of allies", false));
                            return true;
                        }
                        if ($this->plugin->getAlliesCount($fac) >= $this->plugin->getAlliesLimit()) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction has the maximum amount of allies", false));
                            return true;
                        }
                        ...
                        $stmt->bindValue(":timestamp", time());
                        $result = $stmt->execute();
                        $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a You requested to ally with $args[1]!\nWait for the leader's response...", true));
                        $leader->sendMessage($this->plugin->formatMessage("§l§e»§r§e The leader of $fac requested an alliance.\nType /f allyok to accept or /f allyno to deny.", true));
                    }
                    if (strtolower($args[0] == "breakalliancewith") or strtolower($args[0] == "notally")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: §7/f breakalliancewith <faction>"));
                            return true;
                        }
                        if (!$this->plugin->isInFaction($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§cYou must be in a faction to do this"));
                            return true;
                        }
                        if (!$this->plugin->isLeader($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be the leader to do this"));
                        ...
                        if ($this->plugin->getPlayerFaction($playerName) == $args[1]) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction can not break alliance with itself"));
                            return true;
                        }
                        if (!$this->plugin->areAllies($this->plugin->getPlayerFaction($playerName), $args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction is not allied with $args[1]"));
                            return true;
                        }
                        ...
                        $this->plugin->updateAllies($fac);
                        $this->plugin->updateAllies($args[1]);
                        $sender->sendMessage($this->plugin->formatMessage("§l§e»§r§e Your faction $fac is no longer allied with $args[1]", true));
                        if ($leader instanceof Player) {
                            $leader->sendMessage($this->plugin->formatMessage("§l§a»§r§a The leader of $fac broke the alliance with your faction $args[1]", false));
                        }
                    }
                    if (strtolower($args[0] == "forceunclaim")) {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Usage: /f forceunclaim <faction>"));
                            return true;
                        }
                        if (!$this->plugin->factionExists($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("The requested faction doesn't exist"));
                    ...
                    if (strtolower($args[0] == "allyok")) {
                        ...
                        if (!$this->plugin->isLeader($playerName)) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You must be a leader to do this"));
                            return true;
                        }
                        $lowercaseName = strtolower($playerName);
                        ...
                        $array = $result->fetchArray(SQLITE3_ASSOC);
                        if (empty($array) == true) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Your faction has not been requested to ally with any factions"));
                            return true;
                        }
                        ...
                        if (($currentTime - $allyTime) <= 60) { //This should be configurable
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Your faction has successfully allied with $requested_fac", true));
                            ...
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Request has timed out"));
                            $this->plugin->db->query("DELETE FROM alliance WHERE player='$lowercaseName';");
                        }
                    }
                    if (strtolower($args[0]) == "allyno") {
                        ...
                        if (($currentTime - $allyTime) <= 60) { //This should be configurable
                            ...
                            $sender_fac = $this->plugin->getPlayerFaction($playerName);
                            $this->plugin->db->query("DELETE FROM alliance WHERE player='$lowercaseName';");
                            $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Your faction has successfully declined the alliance request.", true));
                    ...
                    if (strtolower($args[0] == 'about')) {
                        $sender->sendMessage(TextFormat::GREEN . "§l§d»§r§d " . TextFormat::BOLD . "HCFPro");
                        $sender->sendMessage(TextFormat::GOLD . "§l§d»§r§d by" . TextFormat::BOLD . "EmeraldMC/Caulfergi");
                    }
                    ////////////////////////////// CHAT ////////////////////////////////
                    if (strtolower($args[0]) == "chat" or strtolower($args[0]) == "c") {

                        if (!$this->plugin->prefs->get("AllowChat")){
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c All Faction chat is disabled", false));
                            return true;
                        }
                        ...
                        if ($this->plugin->isInFaction($playerName)) {
                            if (isset($this->plugin->factionChatActive[$playerName])) {
                                unset($this->plugin->factionChatActive[$playerName]);
                                $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Faction chat disabled", false));
                                return true;
                            } else {
                                $this->plugin->factionChatActive[$playerName] = 1;
                                $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Faction chat enabled", false));
                                return true;
                            }
                        } else {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You are not in a faction"));
                    ...
                    if (strtolower($args[0]) == "allychat" or strtolower($args[0]) == "ac") {
                        ...
                        if ($this->plugin->isInFaction($playerName)) {
                            if (isset($this->plugin->allyChatActive[$playerName])) {
                                unset($this->plugin->allyChatActive[$playerName]);
                                $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Ally chat disabled", false));
                                return true;
                            } else {
                                $this->plugin->allyChatActive[$playerName] = 1;
                                $sender->sendMessage($this->plugin->formatMessage("§l§a»§r§a Ally chat enabled", false));
                                return true;
                            }
                        } else {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c You are not in a faction"));
                ...
                if (strtolower($args[0]) == 'info') {
                    if (isset($args[1])) {
                        if (!(ctype_alnum($args[1])) or !($this->plugin->factionExists($args[1]))) {
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Faction does not exist"));
                            $sender->sendMessage($this->plugin->formatMessage("§l§c»§r§c Make sure the name of the selected faction is ABSOLUTELY EXACT."));
                            return true;
                        }
                        $faction = $args[1];
                        ...
                        $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . "§7==========§l§cINFO§r§7==========" . TextFormat::RESET);
                        $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . "§l§a»§r§a Faction: " . TextFormat::GREEN . "§7$faction" . TextFormat::RESET);
                        $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . "§l§a»§r§a Leader: " . TextFormat::YELLOW . "§7$leader" . TextFormat::RESET);
                        $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . "§l§a»§r§a Players: " . TextFormat::LIGHT_PURPLE . "§7$numPlayers" . TextFormat::RESET);
                        $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . "§l§a»§r§a DTR: " . TextFormat::RED . "§7$power" . "" . TextFormat::RESET);
                        $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . "§l§a»§r§a Description: " . TextFormat::AQUA . TextFormat::UNDERLINE . "§7$message" . TextFormat::RESET);
                        $sender->sendMessage(TextFormat::GOLD . TextFormat::ITALIC . "§7==========§l§cINFO§r§7==========" . TextFormat::RESET);
                    } else {
                        if (!$this->plugin->isInFaction($playerName)) {
